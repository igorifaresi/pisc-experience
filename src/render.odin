...
draw_text_shortcut_hint :: proc(cstr: cstring, x, y: i32, color: ray.Color) {
	ray.DrawTextEx(config.shortcut_hint_font, cstr, ray.Vector2{f32(x), f32(y)}, config.shortcut_hint_font_size, 1.0, color)
}